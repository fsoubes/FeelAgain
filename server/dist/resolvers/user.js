...
let UserResolver = class UserResolver {
    ...
    changePassword(token, newPassword, { redis, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield User_1.UserModel.updateOne({ _id: userId }, {
    ...
    forgotPassword(email, { redis }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis.set(constant_1.FORGET_PASSWORD_PREFIX + token, user.id, "ex", 1000 * 60 * 60 * 24 * 1);
    ...
    me({ req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield User_1.UserModel.findById({ _id: req.session.userId });
            return user;
        });
    }
    register(userInput, {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!validation_1.validateEmail(userInput.email)) {
                    return {
                        errors: [
                            {
                                field: "email",
                ...
                const user = new User_1.UserModel(Object.assign(Object.assign({}, userInput), { password: hashedPassword }));
                yield user.save();
                return { user };
            }
            catch (err) {
    ...
    login(userInput, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield User_1.UserModel.findOne({ email: userInput.email });
            if (!user) {
                return {
                    errors: [{ field: "email", message: "That e-mail doesn't exist" }],
                };
            }
            const isValid = yield argon2_1.default.verify(user.password, userInput.password);
            if (!isValid) {
                return {
...
__decorate([
    type_graphql_1.Mutation((_returns) => UserResponse),
    __param(0, type_graphql_1.Arg("user")),
    __param(1, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_input_1.UserRegister, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(1, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_input_1.UserLogin, Object]),
    __metadata("design:returntype", Promise)
