...
const seedDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield mongoose_1.default.connection.models.User.create([
            {
                email: "bob@bob.fr",
                nickname: "bob",
                password: "$argon2i$v=19$m=4096,t=3,p=1$SKcpzKdXCrqY4RvImpFKBA$MCO99B5R/yVdICwkRph9lfBAqxeoMxEwppB65aTVSEs",
            },
            {
                email: "bob2@bob.fr",
                nickname: "bob2",
        ...
        yield mongoose_1.default.connection.models.Blog.create([
            {
            ...
            {
                title: "Healing",
                description: "Insert of Intralum Dev into R Innom Vein, Perc Endo Approach",
            ...
            },
            {
                ...
                article: "Need for prophylactic vaccination and inoculation against tuberculosis [BCG]",
                isPublished: true,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                description: "Dilate of R Ant Tib Art with 4+ Intralum Dev, Open Approach",
                image_url: "http://dummyimage.com/131x242.png/dddddd/000000",
                article: "Deep necrosis of underlying tissues [deep third degree] with loss of a body part, of chin",
                isPublished: true,
                author: defaultUser._id,
            },
            {
                ...
                article: "Mechanical failure of instrument or apparatus during unspecified procedure",
                isPublished: false,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                description: "Supplement R Foot Muscle with Autol Sub, Perc Endo Approach",
            ...
            },
            {
                ...
                description: "Supplement L Glenoid Cav with Autol Sub, Perc Endo Approach",
                image_url: "http://dummyimage.com/242x138.png/cc0000/ffffff",
                article: "Spontaneous abortion, complicated by metabolic disorder, complete",
                isPublished: true,
                author: defaultUser._id,
            },
            {
                ...
                article: "Infections of nipple associated with childbirth, postpartum condition or complication",
                isPublished: false,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                article: "Combinations of opioid type drug with any other drug dependence, episodic",
                isPublished: false,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                article: "Tuberculosis of intrathoracic lymph nodes, bacteriological or histological examination not done",
                isPublished: true,
                author: defaultUser._id,
            },
            {
                title: "SHISEIDO THE SKINCARE TINTED MOISTURE PROTECTION",
                description: "Extirpation of Matter from Left Renal Artery, Open Approach",
            ...
            {
                title: "TERRACOTTA JOLI TEINT BEAUTIFYING FOUNDATION WITH SUNSCREEN SUN-KISSED, HEALTHY GLOW BROAD SPECTRUM SPF 20 NATURAL",
                ...
                article: "Tuberculosis of lung with cavitation, tubercle bacilli found (in sputum) by microscopy",
                isPublished: false,
                author: defaultUser._id,
            },
            {
                ...
                article: '"Light-for-dates"without mention of fetal malnutrition, 1,250- 1,499 grams',
                isPublished: true,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                article: "Unspecified adverse effect of other drug, medicinal and biological substance",
                isPublished: false,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                article: "Nonspecific (abnormal) findings on radiological and other examination of abdominal area, including retroperitoneum",
                isPublished: false,
                author: defaultUser._id,
            },
            {
                ...
                article: "Nephritis and nephropathy, not specified as acute or chronic, with lesion of rapidly progressive glomerulonephritis",
                isPublished: false,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                article: "Amniotic fluid embolism, delivered, with mention of postpartum complication",
                isPublished: true,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                article: "Injury to other intra-abdominal organs with open wound into cavity, unspecified intra-abdominal organ",
                isPublished: false,
                author: defaultUser._id,
            },
            {
                ...
                article: "Other noncollision motor vehicle traffic accident injuring unspecified person",
                isPublished: false,
                author: defaultUser._id,
            },
            {
            ...
            },
            {
                ...
                description: "Replacement of R Com Iliac Art with Synth Sub, Open Approach",
                image_url: "http://dummyimage.com/154x136.png/dddddd/000000",
                article: "Spontaneous abortion, complicated by genital tract and pelvic infection, unspecified",
                isPublished: true,
                author: defaultUser._id,
            },
            {
                title: "LOreal Paris Men Expert Vita Lift Daily Moisturizer Sunscreen Broad Spectrum SPF 15",
            ...
            },
            {
                ...
                article: "Cardiac catheterization as the cause of abnormal reaction of patient, or of later complication, without mention of misadventure at time of procedure",
                isPublished: true,
                author: defaultUser._id,
            },
        ]);
...
const clearDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        testpro.forEach((key) => __awaiter(void 0, void 0, void 0, function* () {
