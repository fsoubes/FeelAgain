...
function seedDataBase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const secondUser = new User_1.UserModel({
            email: "bob2@bob.fr",
            nickname: "bob2",
            password: "$argon2i$v=19$m=4096,t=3,p=1$SKcpzKdXCrqY4RvImpFKBA$MCO99B5R/yVdICwkRph9lfBAqxeoMxEwppB65aTVSEs",
        });
        const thirdUser = new User_1.UserModel({
            email: "bob3@bob.fr",
            nickname: "bob3",
            password: "$argon2i$v=19$m=4096,t=3,p=1$SKcpzKdXCrqY4RvImpFKBA$MCO99B5R/yVdICwkRph9lfBAqxeoMxEwppB65aTVSEs",
        });
        yield Promise.all([defaultUser.save(), secondUser.save(), thirdUser.save()]);
        yield Blog_1.BlogModel.create([
            {
