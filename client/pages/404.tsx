...
import { particles } from "../src/constants/particles";
    ...
    <Layout>
      <div className={styles.permission_denied}>
        <Particles
          ...
          params={{ particles: particles.particles, fpsLimit: 60 }}
        ></Particles>
        <div className={styles.denied__wrapper}>
          ...
          <svg
            ...
            viewBox="0 0 512 512"
          >
            <circle cx="256.8" cy="255.3" r="247.9" className={styles.st0} />
            <path
            ...
            <path
              ...
              className={`${styles.st4} ${styles.st5}`}
            />
            <path
            ...
            <path
              ...
              className={styles.st1}
            />
            <circle cx="230.7" cy="316.7" r="10.4" className={styles.st7} />
            <path
              ...
              className={styles.st1}
            />
            <circle cx="230.7" cy="345.2" r="10.4" className={styles.st8} />
            <path
            ...
            <path
              ...
              className={`${styles.st5} ${styles.st10}`}
            />
            <path
            ...
            <path
              ...
              className={`${styles.st11} ${styles.st12}`}
            />
            <path d="M371.6 128.9l25.1-23.8" className={styles.st13} />
            <path
              ...
              className={styles.st1}
            />
            <path d="M139.7 128.9l-25.1-23.8" className={styles.st13} />
            <path
              ...
              className={styles.st1}
            />
            <circle cx="114.6" cy="105.1" r="4.8" className={styles.st14} />
            <path
            ...
            />
            <circle cx="396.7" cy="105.1" r="4.8" className={styles.st16} />
            <path
              ...
              className={styles.st15}
            />
            <path d="M351.9 478.1H376" className={styles.st3} />
            <g>
              <path d="M138 478.1h-18.3" className={styles.st3} />
            </g>
            <g>
              <path
          ...
          >
            <circle
              ...
              fill="#FF4F54"
            />
            <g className={styles["saturn-2"]} fill="#EA4753">
          ...
          <NextLink href="/">
            <button className={styles.denied__link}>Go Home</button>
          </NextLink>
          <div />
        </div>
      </div>
